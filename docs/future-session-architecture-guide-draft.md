...
6. `docs/supabase-cleanup-batch-b-d-preview.sql`
7. `docs/supabase-cleanup-batch-c-preview.sql`
8. `docs/gas-cleanup-batch-e-f-preview.md`
9. `logs/timeline.md`
10. Recent `logs/sessions/` entries, especially:
