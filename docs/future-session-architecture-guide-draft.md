...
7. `docs/supabase-cleanup-batch-b-d-preview.sql`
8. `docs/supabase-cleanup-batch-c-preview.sql`
9. `docs/gas-cleanup-batch-e-f-preview.md`
10. `logs/timeline.md`
11. Recent `logs/sessions/` entries, especially:
